  ...
  const { data, error } = await executeSupabaseQuery(
    ...
    () => supabase
      ...
      .insert({
        ...
        canon: seed.translation.canon ?? null,
        canon_type: seed.translation.canon_type ?? seed.translation.canon ?? null,
        license_name: seed.translation.license_name ?? null,
        license_url: seed.translation.license_url ?? null,
        source: seed.translation.source ?? null,
        source_url: seed.translation.source_url ?? seed.translation.source ?? null,
        publisher: seed.translation.publisher ?? null,
        copyright: seed.translation.copyright ?? null,
        copyright_notice: seed.translation.copyright_notice ?? seed.translation.copyright ?? null,
        attribution: seed.translation.attribution ?? null,
        attribution_text: seed.translation.attribution_text ?? seed.translation.attribution ?? null,
        audio_generation_allowed: seed.translation.audio_generation_allowed ?? false,
        ai_processing_allowed: seed.translation.ai_processing_allowed ?? false,
        active: seed.translation.active ?? true,
        default_translation: seed.translation.default_translation ?? false,
        is_active: seed.translation.active ?? true,
      })
      .select("id, code")
      .single(),
  );
