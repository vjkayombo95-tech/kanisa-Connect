...
export const CHURCH_ADMIN_FEATURE_ROUTE_MAP: Array<{ prefix: string; featureKey: ChurchAdminFeatureKey }> = [
  ...
  { prefix: "/church-admin/calendar", featureKey: "events" },
  { prefix: "/church-admin/pastoral-calendar", featureKey: "events" },
  { prefix: "/church-admin/finance-calendar", featureKey: "events" },
