...
export const memberServiceRegistry: MemberServiceDefinition[] = [
  ...
  { id: "jumuiya", path: "/portal/jumuiya", label: "Jumuiya Yangu", description: "Angalia Jumuiya ya parokia uliyopewa", group: "community", iconKey: "users", featureKey: null, ordinaryMemberAllowed: true, showInServices: true, backTitle: "Jumuiya Yangu" },
  { id: "notifications", path: "/portal/notifications", label: "Arifa", description: "Taarifa na vikumbusho vyako", group: "parish", iconKey: "announcement", featureKey: "notifications", ordinaryMemberAllowed: true, showInServices: false, backTitle: "Arifa", requiresExistingFeature: true },
  ...
  { id: "channels", path: "/portal/channels", label: "Mawasiliano", description: "Soma na jibu ujumbe wa vikundi vyako", group: "parish", iconKey: "message", featureKey: "channels", ordinaryMemberAllowed: true, showInServices: true, backTitle: "Njia za Mawasiliano", requiresExistingFeature: true },
  ...
  { id: "event-requests", path: "/portal/event-requests", label: "Huduma za Ofisi", description: "Omba huduma na fuatilia maombi yako", group: "parish", iconKey: "calendar", featureKey: "event_requests", ordinaryMemberAllowed: true, showInServices: false, backTitle: "Huduma za Ofisi" },
  { id: "calendar", path: "/portal/calendar", label: "Ratiba ya Parokia", description: "Misa na matukio yajayo ya parokia", group: "parish", iconKey: "calendar", featureKey: "events", ordinaryMemberAllowed: true, showInServices: true, backTitle: "Ratiba" },
  ...
  { id: "livestream", path: "/portal/live", matchPrefixes: ["/portal/live/"], label: "Misa Mubashara", description: "Tazama Misa mubashara", group: "worship", iconKey: "church", featureKey: "livestream", ordinaryMemberAllowed: true, showInServices: false, backTitle: "Misa Mubashara", requiresExistingFeature: true },
