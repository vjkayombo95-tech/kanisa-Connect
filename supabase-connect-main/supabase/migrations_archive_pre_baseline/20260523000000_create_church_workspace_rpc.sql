-- Compatibility columns used by workspace/RLS helpers added later in history.
ALTER TABLE public.churches ADD COLUMN IF NOT EXISTS owner_id uuid REFERENCES auth.users(id) ON DELETE SET NULL;
